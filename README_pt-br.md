...
JavaScript eh uma boa linguagem. Ela tem uma sintaxe simples, um largo ecossistema, e a parte mais importante, uma grande comunidade.

Ao mesmo tempo, we all know that JavaScript is quite a funny language with tricky parts. Some of them can quickly turn our everyday job into hell, and some of them can make us laugh out loud.
...
Voce pode instalar este handbook atraves do comando `npm`. Apenas digite:
...
**`// ->`** usado para mostrar o resultado de uma expressao. Por exemplo:
